document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      const minLength = field.getAttribute('data-min-length') || field.getAttribute('minlength');
      let errorMessage = '';
      ...
      if (required && !validators.required(value)) {
        ...
        } else if (minLength && !validators.minLength(value, minLength)) {
          errorMessage = errorMessages.minLength + ' (min ' + minLength + ' characters)';
        }
      }
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      const currentFields = contactForm.querySelectorAll('input, textarea, select');
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "ChefMarket משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '77db93b7-1a8f-43f4-b641-a4835e078e0b',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '77db93b7-1a8f-43f4-b641-a4835e078e0b';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '77db93b7-1a8f-43f4-b641-a4835e078e0b';
